...
const translationsEn: Record<string, string> = {
  ...
  "professional.service3.title": "AI Integration",
  "professional.service3.description": "Our AI integration services connect artificial intelligence with your existing ERP, CRM, and other enterprise systems.",
  "professional.service4.title": "Agentic AI Development",
  "professional.service4.description": "Empower your business with autonomous agents capable of complex problem-solving, advanced process automation, and intelligent decision-making.",
  "professional.service5.title": "Generative AI Development",
  "professional.service5.description": "Specializing in Generative AI in Saudi Arabia, we create solutions powered by Large Language Models (LLMs) for content generation, automation, and predictive analytics.",
  "professional.service6.title": "Conversational AI",
  "professional.service6.description": "We design sophisticated conversational AI solutions that deliver human-like interactions, automate customer communication, and significantly improve user experiences.",
...
const translationsAr: Record<string, string> = {
  ...
  // Hero Section
  "hero.title": "حوّل بياناتك إلى قرارات ذكية",
  ...
  "professional.service3.title": "تكامل الذكاء الاصطناعي",
  "professional.service3.description": "تربط خدمات تكامل الذكاء الاصطناعي لدينا الذكاء الاصطناعي بأنظمة تخطيط موارد المؤسسات (ERP) وإدارة علاقات العملاء (CRM) وأنظمة المؤسسات الأخرى الموجودة لديك.",
  "professional.service4.title": "تطوير الذكاء الاصطناعي الوكيل",
  "professional.service4.description": "عزز عملك بوكلاء مستقلين قادرين على حل المشكلات المعقدة، والأتمتة المتقدمة للعمليات، واتخاذ القرارات الذكية.",
  "professional.service5.title": "تطوير الذكاء الاصطناعي التوليدي",
  "professional.service5.description": "متخصصون في الذكاء الاصطناعي التوليدي في المملكة العربية السعودية، نبتكر حلولاً مدعومة بنماذج اللغة الكبيرة (LLMs) لإنشاء المحتوى والأتمتة والتحليلات التنبؤية.",
  "professional.service6.title": "الذكاء الاصطناعي الحواري",
  "professional.service6.description": "نصمم حلول ذكاء اصطناعي حوارية متطورة تقدم تفاعلات شبيهة بالبشر، وتؤتمت التواصل مع العملاء، وتحسن تجارب المستخدمين بشكل كبير.",
