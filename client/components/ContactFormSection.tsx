            ...
            <form className="max-w-[672px] mx-auto space-y-4 sm:space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    type="text"
                    required
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base rounded-lg border border-[rgba(121,64,190,0.30)] bg-[rgba(27,34,50,0.70)] backdrop-blur-[10px] text-[#FCFBF8] placeholder:text-[#A7AFBE] focus:outline-none focus:ring-2 focus:ring-[#00D4FF]"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  required
                  rows={4}
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base rounded-lg border border-[rgba(121,64,190,0.30)] bg-[rgba(27,34,50,0.70)] backdrop-blur-[10px] text-[#FCFBF8] placeholder:text-[#A7AFBE] focus:outline-none focus:ring-2 focus:ring-[#00D4FF] resize-none"
