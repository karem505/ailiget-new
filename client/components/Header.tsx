      ...
      <div className="flex items-center justify-between px-6 py-3 rounded-full bg-[rgba(14,21,37,0.60)] backdrop-blur-[10px]">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 px-[17px] py-[9px] rounded-[14px] border border-[rgba(0,212,255,0.30)] bg-[rgba(27,34,50,0.70)] backdrop-blur-[10px] shadow-[0_8px_32px_0_rgba(0,0,0,0.40),0_0_20px_0_rgba(0,212,255,0.15)] hover:bg-[rgba(27,34,50,0.90)] transition-all"
          >
            <Globe className="w-4 h-4 text-[#00D4FF]" />
            <span className="text-sm font-medium text-[#FCFBF8]">
              {language === "en" ? "EN" : "ع"}
            </span>
          </button>
          ...
          <button className="px-6 py-2.5 rounded-[14px] bg-gradient-to-r from-[#9952E0] to-[#00D4FF] text-sm font-semibold text-white hover:opacity-90 transition-opacity">
            {t("header.schedule")}
          </button>
        </div>
      </div>
