...
const teamMembers = [
  {
    ...
    image: "https://api.builder.io/api/v1/image/assets/TEMP/8e14fe56939827f567f7772c1176762f02b45bf0?width=258"
  },
  {
    name: "Dr. Karem Shohoud",
    role: "CMO",
    position: "Chief Executive Officer",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/8a30d450e67e3f46363339267dd2a4e2c7bc28c6?width=288"
  },
  {
    name: "Dr. Sohaila Abuelliel",
    role: "CMO",
    position: "Chief Executive Officer",
    image: "https://api.builder.io/api/v1/image/assets/TEMP/c8094a62569ee3d3b7a08b67ea5cdeee904b4d4c?width=250"
  }
];
                ...
                <div className="relative flex flex-col items-center gap-9 p-14">
                  ...
                  <div className="text-center space-y-3">
                    ...
                    <button className="inline-flex items-center gap-2 px-3 py-2 rounded-[14px] border border-[rgba(103,80,164,0.08)] bg-[rgba(27,34,50,0.70)] backdrop-blur-[10px] shadow-[0_8px_32px_0_rgba(0,0,0,0.40),0_0_20px_0_rgba(0,212,255,0.15)]">
                      ...
                      <span className="text-sm font-medium font-inter text-[#FCFBF8]">LinkedIn</span>
                    </button>
                  </div>
                </div>
              </div>
